...
public class SinglePlayGameOver extends Application {
    ...
    private void addText() {
        ...
        Text computerScore = createText("Computer points: " + computerPoints, 30, Color.WHITE);
        ...
        Text whoWin = computerPoints < userPoints ? createText("You win!", 50, Color.GREEN) :
                computerPoints > userPoints ? createText("Computer win! :(", 50, Color.RED) :
